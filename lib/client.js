window.__ModuleLoader__.load({
	id: "@asuka1121/dsh-client-ui-elasticsearch",
	factory: (require) => {
		var module = { exports: {} };
		...
		Schema.object({
			uris: Schema.array(Schema.string()).default([]),
			username: Schema.string().default(""),
			password: Schema.string().default("")
		});
		//#endregion
		//#region lib/types/client/ElasticsearchSection.js
		/**
		...
		*/
		function ElasticsearchSection(props) {
			const scope = props.scope;
			const t = props.t;
			if (scope === void 0 || t === void 0) return null;
			const [snapshot, setSnapshot] = (0, react.useState)(() => scope.getSnapshot());
			const [draft, setDraft] = (0, react.useState)(() => draftOf(scope.getSnapshot().value));
			...
			(0, react.useEffect)(() => {
				const sync = () => {
					...
					setSnapshot(next);
					if (!seededRef.current && next.value !== void 0) {
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("button", {
							...
							style: {
								...
								opacity: busy || readOnly ? .6 : 1
							},
							children: busy ? t("saving") : t("save")
						}), message !== "" ? (0, react_jsx_runtime.jsx)("span", {
							style: {
								fontSize: 13,
								opacity: .8
							},
		...
		*/
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, {
				zh,
				en
			}), "ui-elasticsearch: copy dictionaries");
			const scope = ctx.settingsScope.bind({ namespace: ELASTICSEARCH_SETTINGS_NAMESPACE });
		...
		//#endregion
		exports.ELASTICSEARCH_SETTINGS_NAMESPACE = ELASTICSEARCH_SETTINGS_NAMESPACE;
		exports.apply = apply;
